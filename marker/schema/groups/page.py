...
class PageGroup(Group):
  ...
  def assemble_html(self, document, child_blocks, parent_structure=None, block_config=None):
    template = ""
  ...
  def identify_missing_blocks(
    ...
    for line_idx in provider_line_idxs:
      ...
      if provider_outputs[line_idx].line.polygon.area <= 1 and provider_outputs[line_idx].raw_text == "\n":
        continue
      ...
      if new_block is None:
        ...
        [
          ...
          provider_outputs[line_idx].line.polygon.center_distance(new_block[-1][1].line.polygon)
