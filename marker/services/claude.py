...
class ClaudeService(BaseService):
  claude_model_name: Annotated[str, "The name of the Google model to use for the service."] = (
    "claude-3-7-sonnet-20250219"
  )
  claude_api_key: Annotated[str, "The Claude API key to use for the service."] = None
  max_claude_tokens: Annotated[int, "The maximum number of tokens to use for a single Claude request."] = 8192
