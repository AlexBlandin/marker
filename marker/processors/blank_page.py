...
class BlankPageProcessor(BaseProcessor):
  ...
  full_page_block_intersection_threshold: Annotated[float, "Threshold to detect blank pages at"] = 0.8
  filter_blank_pages: Annotated[bool, "Remove blank pages detected as images."] = False
  ...
  def is_blank(self, image: Image.Image):
    ...
    binarized = cv2.adaptiveThreshold(gray, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY_INV, 31, 15)
