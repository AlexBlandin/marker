...
class LineMergeProcessor(BaseProcessor):
  ...
  min_merge_pct: Annotated[float, "The minimum percentage of intersection area to consider merging."] = 0.015
  block_expand_threshold: Annotated[float, "The percentage of the block width to expand the bounding box."] = 0.05
  min_merge_ydist: Annotated[float, "The minimum y distance between lines to consider merging."] = 5
  intersection_pct_threshold: Annotated[
    float, "The total amount of intersection area concentrated in the max intersection block."
  ] = 0.5
